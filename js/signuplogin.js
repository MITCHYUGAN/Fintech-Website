...
login.addEventListener('click', function(){
    ...
    }else if(input[3].value === companyName || input[4].value === password ){
        window.location.replace('file:///C:/Users/MITCHIGAN/Documents/FINTECH%20WEBSITE/dashboard.html')
    }
    else{
        alert("Check your password or Company's name well")
    }
})
...
submitbtn.addEventListener('click', function(){
    ...
    else if(input[0].value === comemail || input[1].value === companyName || input[2].value === password){
        window.location.replace('file:///C:/Users/MITCHIGAN/Documents/FINTECH%20WEBSITE/dashboard.html')
    }
    console.log("effieg");
})
